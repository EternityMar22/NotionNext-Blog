...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '8c64d3871ab44bff872ab7eaa59beb07',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.kaitp.com', // 网站地址
  KEYWORDS:
    process.env.NEXT_PUBLIC_KEYWORD || 'kai, 博客,blog,金融时报,小作文,段子', // 网站关键词 英文逗号隔开
